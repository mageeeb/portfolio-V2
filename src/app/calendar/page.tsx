...
export default function Calendar() {
  ...
  for (let i = 0; i < firstDayOfMonth; i++) {
    calendarDays.push(<Flex key={`empty-${i}`} flex={1} padding="m" />);
  }
              ...
              {appointments[selectedDate].map((appointment, index) => (
                <Flex 
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    transform: selectedAppointment === appointment ? "translateY(-4px) scale(1.02)" : "translateY(0) scale(1)",
                    boxShadow: selectedAppointment === appointment ? "0 8px 16px rgba(0, 0, 0, 0.15)" : "0 4px 12px rgba(0, 0, 0, 0.1)",
                    position: "relative",
                    overflow: "hidden"
                  }}
