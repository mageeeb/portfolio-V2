...
import { SmartImageProps } from "@/once-ui/components";
import { Skeleton } from "@/once-ui/components/Skeleton";
import { FixedFlex } from "./FixedFlex";

// This component is a copy of the SmartImage component that uses FixedFlex instead of Flex
// to fix the "text-align" issue
const FixedSmartImage: React.FC<SmartImageProps> = ({
  aspectRatio,
  height,
  alt = "",
  isLoading = false,
